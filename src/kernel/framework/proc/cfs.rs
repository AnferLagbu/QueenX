...
//! CFS (Completely Fair Scheduler) — 调度策略 — framework 机制实现
//!
//! ## DECISION-J 归属反转记录 (2026-09-13)
//!
//! 策略代码 (权重表 + vruntime 计算 + 时间片计算 + CFS/DL 运行队列) 于
//! T1-1 (2026-06-16) 迁至 `services::proc::sched_policy`, 本文件仅
//! re-export。按统一判据反转：CfsRunQueue/DlRunQueue 是 framework scheduler
